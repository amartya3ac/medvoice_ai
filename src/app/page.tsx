    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        <div className="container mx-auto px-4 z-10 text-center relative max-w-5xl">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex items-center gap-3 px-5 py-2.5 rounded-full bg-slate-900/40 border border-emerald-500/20 mb-8 hero-anim backdrop-blur-xl shadow-[0_0_30px_rgba(16,185,129,0.1)] hover:border-emerald-500/40 transition-colors">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-emerald-400">
                System Live: 200ms latency
              </span>
            </div>

            {/* Headline */}
            <h1 className="text-4xl sm:text-7xl md:text-9xl font-black tracking-tighter mb-4 hero-anim leading-[0.9] text-white">
              Smarter
              <br />
            ...
            {/* Subheadline */}
            <p className="max-w-2xl mx-auto text-lg md:text-2xl text-slate-400 mb-6 hero-anim leading-relaxed font-light">
              Experience clinical-grade medical intelligence. Describe symptoms
              via voice, upload prescriptions for AI analysis, and connect with
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-5 hero-anim w-full mt-4">
              ...
              <a
                href="#features"
                className="w-full sm:w-auto py-4 px-10 rounded-2xl glass bg-slate-800/50 border border-white/10 text-white font-bold hover:bg-slate-800/80 hover:border-white/20 transition-all duration-300 flex items-center justify-center gap-3 group hover:-translate-y-1"
              >
          ...
          {/* Trust Indicators */}
          <div className="mt-4 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 hero-anim">
          ...
          <div
            ...
            className="mt-8 relative max-w-3xl mx-auto hero-anim group"
          >
            ...
            <div className="glass-card flex flex-col items-center justify-center p-8 md:p-12 relative overflow-hidden bg-slate-900/50 shadow-[0_25px_50px_rgba(0,0,0,0.4)]">
              ...
              <div className="flex items-end gap-1 h-16 w-full max-w-md justify-center opacity-80 mb-6">
                {[...Array(28)].map((_, i) => (
                  <div
                    key={i}
                    className="w-2 rounded-full bg-gradient-to-t from-blue-500 to-violet-400"
                    style={{
                      height: isClient
                        ? `${Math.max(15, Math.random() * 100)}%`
                        : "40%",
                      animationName: isClient ? "waveform-bar" : "none",
                      animationDuration: isClient
              ...
              <div className="bg-white/[0.03] backdrop-blur-xl rounded-2xl px-6 py-4 border border-white/[0.06] flex items-center gap-3 shadow-xl relative w-full max-w-md">
                ...
                <span className="text-base font-medium text-slate-300 relative z-10">
                  &quot;I&apos;m experiencing a severe tension headache...&quot;
                </span>
              </div>
            </div>
          </div>
      ...
      <section ref={statsRef} className="py-16 relative z-10">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-4xl mx-auto">
            ...
            />
            <StatItem
              icon={<Stethoscope className="w-6 h-6 text-violet-400" />}
              value="200+"
      ...
      <section id="features" ref={featuresRef} className="py-24 relative z-10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <span className="text-violet-400 font-semibold tracking-widest uppercase text-xs mb-3 block">
            ...
            <p className="text-slate-400 text-lg font-light leading-relaxed">
              Our clinical-grade platform combines advanced neural networks with
              human-centric design to deliver medical assistance that&apos;s
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <span className="text-blue-400 font-semibold tracking-widest uppercase text-xs mb-3 block">
              How It Works
            </span>
            ...
            <p className="text-slate-400 text-lg font-light leading-relaxed">
              A meticulously designed four-step pipeline that takes you from
              initial symptom recognition to professional medical guidance —
            ...
            <div className="flex flex-col items-center gap-12 relative z-10">
              ...
              <div className="w-full space-y-5">
                <div className="flex items-center gap-6 p-6 rounded-3xl bg-slate-900/50 border border-white/5 hover:border-blue-500/30 transition-all duration-300 group/item">
                  ...
                  <div className="flex flex-col">
                    <span className="text-lg font-black text-slate-100 uppercase tracking-widest">
                      HIPAA Compliant
                    </span>
              ...
              <div className="text-center space-y-6 pt-4 w-full border-t border-white/5">
                <button className="w-full mt-6 py-6 rounded-3xl bg-slate-900/80 border border-white/10 flex items-center justify-center gap-4 hover:bg-slate-900 transition-all group/btn shadow-xl">
                  ...
                  <span className="text-[11px] font-black text-slate-400 uppercase tracking-[0.1em] md:tracking-[0.4em] group-hover/btn:text-white transition-colors">
                    Technical Protocol
                  </span>
                </button>
      ...
      <section ref={testimonialsRef} className="py-24 relative z-10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <span className="text-emerald-400 font-semibold tracking-widest uppercase text-xs mb-3 block">
              Testimonials
            </span>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 tracking-tight">
      ...
      <section id="faq" className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-slate-400 text-lg font-light">
              Everything you need to know about MedVoice AI and how it can help
              you.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-3xl">
          <div className="glass-card p-10 md:p-14 bg-slate-900/40 border-white/[0.06]">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mb-10 text-sm text-slate-500">
              ...
              <span className="flex items-center gap-1.5">
                <Clock className="w-4 h-4 text-blue-400" /> Results in under 60
                seconds
              </span>
              <span className="flex items-center gap-1.5">
                <Lock className="w-4 h-4 text-violet-400" /> 100% private &amp;
                secure
              </span>
            </div>
            ...
            <Link
              href="/chatbot"
              className="btn-primary inline-flex items-center gap-2.5 text-lg px-12 py-5 animate-pulse-glow"
            >
...
function FeatureCard({
  ...
  return (
    <div
      className={`feature-card glass-card group flex flex-col h-full bg-slate-900/30 border-t-2 ${accentColors[accent] || "border-t-blue-500/50"}`}
    >
      ...
      <h3 className="text-xl font-bold mb-3 text-white group-hover:text-blue-300 transition-colors tracking-tight">
        {title}
      </h3>
...
function FaqItem({
  ...
  return (
    <div
      className={`glass-card bg-slate-900/30 cursor-pointer transition-all duration-300 ${isOpen ? "border-blue-500/20" : ""}`}
      onClick={() => setOpen(isOpen ? null : index)}
    >
      <div className="flex items-center justify-between gap-4">
        <h3
          className={`font-semibold text-base transition-colors ${isOpen ? "text-blue-400" : "text-slate-200"}`}
        >
          {question}
        </h3>
        <ChevronDown
          className={`w-5 h-5 text-slate-500 flex-shrink-0 transition-transform duration-300 ${isOpen ? "rotate-180 text-blue-400" : ""}`}
        />
      </div>
      {isOpen && (
